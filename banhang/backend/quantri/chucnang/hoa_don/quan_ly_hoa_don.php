...
global $conn;
    ...
    $tv="select count(*) from bill";
    $tv_1=mysqli_query($conn,$tv);
    $tv_2=mysqli_fetch_array($tv_1);
    $so_trang=ceil($tv_2[0]/$so_dong_tren_mot_trang);
   
    $vtbd=($_GET['trang']-1)*$so_dong_tren_mot_trang;
    $tv="select * from bill order by id desc limit $vtbd,$so_dong_tren_mot_trang";
    $tv_1=mysqli_query($conn,$tv);
?>
<table width="990px" class="tb_a1" >
    <tr style="background:#CCFFFF;height:40px;" >
        <td width="200px" ><b>Tên</b></td>
        <td width="280px" ><b>Địa chỉ</b></td>
        <td width="230px" ><b>Email</b></td>
        <td width="130px" ><b>Điện thoại</b></td>
