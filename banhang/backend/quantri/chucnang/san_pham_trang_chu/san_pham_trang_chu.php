...
global $conn;
    ...
    $tv="select count(id) from products where trang_chu='co' ";
    ...
    $tv="select id,name,price,images,sap_xep_trang_chu from products where trang_chu='co' order by sap_xep_trang_chu desc limit $vtbd,$so_dong_tren_mot_trang";
