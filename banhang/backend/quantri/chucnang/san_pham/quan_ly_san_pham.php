...
<div style="width:990px;text-align:left" >
    ...
    <?php
        $tv="select * from ver_menu order by id ";
...
<?php
    ...
    {
        $tv="select count(*) from products where idmenu='$id_menu' ";
    }
    $tv_1=mysqli_query($conn,$tv);
    ...
    if($id_menu=="toan_bo_san_pham")
    {
        $tv="select id,name,price,images from products order by id desc limit $vtbd,$so_dong_tren_mot_trang";
    }
    else
    {
        $tv="select id,name,price,images from products where idmenu='$id_menu' order by id desc limit $vtbd,$so_dong_tren_mot_trang";
    }
    $tv_1=mysqli_query($conn,$tv);
?>
